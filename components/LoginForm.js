    ...
    <div className="flex flex-col justify-center items-center mt-20">
      ...
      <form>
        ...
        <div className="space-y-10 space-x-20">
          <button className="border  border-green-100 bg-transparent text-green-100 rounded-lg w-[161px] h-[50px]">
            Register
          </button>
          <button className="border  border-green-100 bg-green-100 text-white rounded-lg w-[161px] h-[50px]">
            Login
          </button>
        </div>
        <div className="flex items-center">
          ...
          <div className="flex-1 pl-8">
            <a href="#" className="ml-28 text-green text-sm">
              Forget Password
            </a>
          </div>
        </div>
